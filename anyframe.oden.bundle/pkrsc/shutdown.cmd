...
@echo .
@echo . OdenServerService.bat - uninstall script for Oden Server Service
@echo .
...
@echo Stopping Anyframe Oden Server Service... Press Control-C to abort
@pause
@echo .
net stop "Anyframe Oden Server Service"
@echo .

@echo Un-installing Anyframe Oden Server Service... Press Control-C to abort
@pause
@echo .
%JSEXE% -uninstall "Anyframe Oden Server Service"
@echo .
