package anyframe.oden.admin.exception;
...
public class BrokerException extends BaseException {
     ...
     *        exception
     */
    public BrokerException(final MessageSource messageSource,
     ...
     *        exception
     */
    public BrokerException(final String message, final Throwable exception) {
