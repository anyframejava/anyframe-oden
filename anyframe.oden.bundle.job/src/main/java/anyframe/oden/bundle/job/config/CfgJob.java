...
public class CfgJob {
	...
	public CfgJob(String name, CfgSource source, 
			List<CfgTarget> targets, List<CfgCommand> commands){
		this.name = name;
		this.source = source;
	...
	/**
	 * Get targets which are matched with targetNames. 
	 * If targetNames is empty, all targets will be returned.
	 * 
	 * @param targetNames
	 * @return
	 */
	...
	public boolean equals(Object obj) {
		if(obj instanceof CfgJob){
			...
			if(equals(name, cg.getName()) && 
					source.equals(cg.getSource()) &&
