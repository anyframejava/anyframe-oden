package org.anyframe.oden.perforce.compile;
...
public class CompileBroker extends Task {
	...
	private String requestId;// = "[{requestId:PROCESS_DEVELOP_PJT201411251036_14_PJT201411251036,buildId:PROCESS_DEVELOP_PJT201411251036_14_PJT201411251036}]";
