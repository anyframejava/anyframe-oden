 ...
 */
package org.anyframe.oden.admin.broker.service;
 ...
 */
@Service("odenBroker")
public class OdenBrokerImpl implements OdenBroker {
	...
	/**
	 * help command 통해 Server HealthCheck 수행
	 * 
	 * @param shellUrl
	 * @return
	 * @throws BrokerException
	 */
	public boolean healthCheck(String shellUrl) throws BrokerException {
		PrintWriter writer = null;
