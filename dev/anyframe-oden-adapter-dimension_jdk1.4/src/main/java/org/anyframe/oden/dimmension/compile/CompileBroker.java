	...
	public void execute(){
		try {
			...
			BuildInfo build = new BuildInfo(projectName,
					convertJson(requestId), srcRoot, resRoot, webRoot, srcAppd, webAppd, jarWebRoot, packageName, classesRoot, libsRoot, classesRoot2, libsRoot2, classesRoot3, libsRoot3, reference, encoding);
