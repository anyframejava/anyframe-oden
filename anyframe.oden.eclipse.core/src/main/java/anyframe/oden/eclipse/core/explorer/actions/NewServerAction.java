 ...
 * 
 */
public class NewServerAction extends AbstractExplorerViewAction {
	...
	public NewServerAction() {
		super(
				UIMessages.ODEN_EXPLORER_Actions_NewServerAction_CreateServer,
				UIMessages.ODEN_EXPLORER_Actions_NewServerAction_CreateServerToolTip,
				UIMessages.ODEN_EXPLORER_Actions_NewServerAction_CreateServerIcon);
	}
	...
	public void run() {
		CreateServerDialog dialog = new CreateServerDialog(Display.getCurrent()
				.getActiveShell(), CreateServerDialog.Type.CREATE, new Server());
		dialog.open();
