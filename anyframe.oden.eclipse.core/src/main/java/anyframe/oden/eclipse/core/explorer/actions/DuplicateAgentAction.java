 ...
 * 
 */
public class DuplicateAgentAction extends AbstractExplorerViewAction {

	/**
	 * 
	 */
	public DuplicateAgentAction() {
		super(
				OdenMessages.ODEN_EXPLORER_Actions_DuplicateAgentAction_DuplicateAgent,
				OdenMessages.ODEN_EXPLORER_Actions_DuplicateAgentAction_DuplicateAgentToolTip,
				OdenMessages.ODEN_EXPLORER_Actions_DuplicateAgentAction_DuplicateAgentIcon);
	}
	...
	public void run() {
		...
		CreateAgentDialog dialog = new CreateAgentDialog(Display.getCurrent()
				.getActiveShell(), CreateAgentDialog.Type.COPY,
				new Agent(agent));
		dialog.open();
	...
	public boolean isAvailable() {
		if (getView() == null)
			return false;
		return getView().getSelectedAgent(false) != null;
	}
